...
//            [DeallocateOnJobCompletion] public NativeArray<Entity> previouslySelected;
...
//                    //commandBuffer.DestroyEntity(previouslySelected[0]);

//                    commandBuffer.AddComponent(hitBody.Value.Entity, new SelectedBuilding());
...
//                    previouslySelected = GetEntityQuery(typeof(SelectedBuilding)).ToEntityArray(Allocator.TempJob),
...
//        protected override void OnCreate()
//        {
//            m_PickSystem = World.DefaultGameObjectInjectionWorld.GetOrCreateSystem<MousePickSystem>();
//            m_MouseGroup = GetEntityQuery(new EntityQueryDesc
//            {
//                All = new ComponentType[] { typeof(MousePick) }
//            });
