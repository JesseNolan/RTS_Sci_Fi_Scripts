...
//                                Position = input.Ray.Origin + input.Ray.Direction * colliderHit.Fraction,
...
//                            {
//                                Ray = new Ray(Request.PinHole, rayDir),
...
//                                        Collider = (Collider*)sphere.GetUnsafePtr(),
//                                        Orientation = quaternion.identity,
//                                        Position = hitPos + hit.SurfaceNormal * sphereRadius,
//                                        Direction = Request.LightDir * Request.RayLength
//                                    };
...
//                                    var rayCastInput = new RaycastInput
//                                    {
//                                        Ray = new Ray(hitPos, Request.LightDir * Request.RayLength),
//                                        Filter = Request.CollisionFilter
//                                    };
